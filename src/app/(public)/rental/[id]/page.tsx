    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col relative pb-10">
            ...
            <main className="container mx-auto max-w-md px-6 flex flex-col items-center">
                ...
                {/* Hero Image Block */}
                <div className="relative w-full aspect-[4/5] rounded-2xl overflow-hidden shadow-sm mt-2 mb-4 bg-slate-200">
                    {experience.experience_images && experience.experience_images.length > 0 ? (
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-center">
                            <div className="absolute inset-0 bg-blue-300 opacity-60 mix-blend-multiply"></div>
                            {/* Simple text fallback */}
                            <span className="text-white font-bold text-xl uppercase z-10 drop-shadow-sm">{experience.title}</span>
                        </div>
                    )}
                ...
                <div className="w-full bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex flex-col gap-5">
                    ...
                    {/* General Description */}
                    <div>
                        <h4 className="text-xs font-semibold text-slate-800 mb-2">General description of the boat</h4>
                    ...
                    {/* Tags */}
                    {/* Tags disabled due to db structural map changes */}
