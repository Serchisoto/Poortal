...
export default async function CultureShowDetailPage({
    params,
}: {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col relative pb-10">
            ...
            <main className="container mx-auto max-w-md px-6 flex flex-col items-center">
                ...
                {/* Hero Image Block */}
                <div className="relative w-full aspect-[4/5] rounded-2xl overflow-hidden shadow-sm mt-2 mb-4 bg-slate-900">
                    {experience.experience_images && experience.experience_images.length > 0 ? (
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br flex flex-col items-center justify-center p-3 text-center from-slate-900 via-indigo-950 to-slate-800">
                            <span className="text-rose-200 font-serif text-3xl leading-tight uppercase tracking-widest drop-shadow-md z-10">{experience.title}</span>
                ...
                <div className="w-full bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex flex-col gap-5">
                    ...
                    {/* Tags */}
                    {/* Tags disabled due to db mapping changes */}
                    ...
                    <div className="flex items-center justify-between mt-6">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-slate-700">Location description</span>
                        </div>
