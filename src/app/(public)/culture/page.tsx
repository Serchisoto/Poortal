...
import { ChevronLeft, Music2, Map } from 'lucide-react'
            ...
            <main className="container mx-auto max-w-md px-6 flex flex-col items-center mt-2">
                ...
                <div className="w-full bg-white rounded-[2rem] border border-slate-200 shadow-sm p-6 pb-12 flex flex-col items-center">
                    ...
                    <button
                        ...
                        disabled={pending}
                    >
                        <Music2 className="h-12 w-12 mb-3 text-rose-500" strokeWidth={1.25} />
                    ...
                    <button
                        ...
                        disabled={pending}
                    >
                        <Map className="h-12 w-12 mb-3 text-orange-400" strokeWidth={1.25} />
