              ...
              <div className="flex items-center justify-between p-4 rounded-full border border-slate-200 shadow-sm bg-white">
                <div className="flex items-center gap-3 pl-2">
                  <div className="flex flex-col">
                    <div className="text-[10px] text-primary font-bold leading-tight">Admission</div>
                ...
                <div className="flex items-center gap-4 pr-1">
                  ...
                  <button onClick={() => setPeople((p) => p + 1)} className="bg-primary text-white rounded-full p-1.5 shadow-sm active:scale-95">
        ...
        <div className="mb-6 bg-white rounded-[2rem] border border-slate-200 shadow-lg px-6 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className={cn(
              ...
              selectedSlot && !loading ? 'bg-primary' : 'bg-slate-300 cursor-not-allowed'
            )}
          >
            continue
